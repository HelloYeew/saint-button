...
@customElement('saint-button')
export class SaintButton extends LitElement {
    ...
    static get styles() {
        return css`
            ...
            #button {
                ...
                box-shadow: 0 2px 4px #80008070, 0 4px 16px #80008050,
                    0 16px 40px #80008050;
                border: 0;
                outline: none;
                cursor: pointer;
            ...
            #button:hover,
            #button:focus {
                box-shadow: 0 2px 4px #80008080, 0 20px 48px #80008060,
                    0 16px 40px #80008060;
            }
            #title {
